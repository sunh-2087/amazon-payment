...
use Kenini\AmazonPayment\Exceptions;
...
class AmazonPaymentClient {
	...
	function __construct(ClientInterface $client, $config)
	{
		...
		if ($config['sandbox_mode'] === true) {
			$this->serviceUrl = 'https://mws.amazonservices.jp/OffAmazonPayments_Sandbox/2013-01-01';
		} else {
			$this->serviceUrl = 'https://mws.amazonservices.jp/OffAmazonPayments/2013-01-01';
		}
	}
	...
	{
		$customExceptionName = 'Kenini\AmazonPayment\Exceptions\\'. $this->exceptionAlias($amazonCode) .'Exception';
