<?php namespace spec\Kenini\AmazonPayment;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use Kenini\AmazonPayment\AmazonPaymentClient;
...
class AmazonPaymentSpec extends ObjectBehavior {
	...
	function let(AmazonPaymentClient $client)
	{
		...
		$this->shouldHaveType('Kenini\AmazonPayment\AmazonPayment');
	}
	...
	{
		$this->shouldThrow('Kenini\AmazonPayment\Exceptions\InvalidDataException')
