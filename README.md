...
$amazonPayment = new Kenini\AmazonPayment\AmazonPayment(
    new Kenini\AmazonPayment\AmazonPaymentClient(
...
} catch (\Kenini\AmazonPayment\Exceptions\OrderReferenceNotModifiableException $e) {
    // DB::rollback();
